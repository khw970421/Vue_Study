...
// 상대경로를 입력하지 않을 경우 node_modules에 설치된 것이다.
...
class VueElement extends BaseClass {
     ...
     */ _resolveDef() {
        ...
        const resolve = (def)=>{
            ...
            for (const key1 of Object.keys(this))if (key1[0] !== '_') this._setProp(key1, this[key1]);
     ...
     */ _setProp(key, val, shouldReflect = true) {
        if (val !== this._props[key]) {
            this._props[key] = val;
            if (this._instance) this._update();
            // reflect
            if (shouldReflect) {
...
function computed(getterOrOptions, debugOptions) {
    ...
    const cRef = new ComputedRefImpl(getter1, setter, onlyGetter || !setter);
    if (debugOptions) {
...
},{}],"6LWQO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let script;
let initialize = ()=>{
    ...
    script.__scopeId = 'data-v-333096';
    script.__file = "C:\\Users\\82103\\job것들\\Desktop\\Vue_Study\\vue_bundler\\vue_parcel\\src\\App.vue";
};
initialize();
if (module.hot) {
    script.__hmrId = '333096-hmr';
    module.hot.accept(()=>{
        setTimeout(()=>{
            initialize();
            if (!__VUE_HMR_RUNTIME__.createRecord('333096-hmr', script)) __VUE_HMR_RUNTIME__.reload('333096-hmr', script);
        }, 0);
    });
}
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"bY6cb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "render", ()=>render
);
...
function render(_ctx, _cache) {
    return _vue.openBlock(), _vue.createElementBlock("h1", null, _vue.toDisplayString(_ctx.msg), 1 /* TEXT */ );
}
if (module.hot) module.hot.accept(()=>{
    __VUE_HMR_RUNTIME__.rerender('333096-hmr', render);
});
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}]},["kAaS7","i87aF"], "i87aF", "parcelRequireec4d")
